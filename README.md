...
|---|---:|---:|
| OG カード 1200×630 | **18 ms** / 74.7 KB | 58 ms / 73.7 KB |
| OG カード @2x 2400×1260 | **67 ms** / 161.5 KB | 178 ms / 158.9 KB |
| 和文の長いページ 800×1320 | **41 ms** / 366.0 KB | 206 ms / 361.5 KB |

時間の大半は PNG のエンコード（zlib）です。`compression_level` を上げるとファイルは 1〜2% 小さく
なりますが、時間は 3〜5 倍になります。リクエストごとに OG 画像を作るなら既定の 6 が釣り合いますし、
